...
import { Search, MapPin, ChevronRight, Wrench, AlertCircle } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-card p-6">
            ...
            {!searchQuery && activeCategory === "All" && (
              <div className="mb-5">
                <p className="text-xs font-montserrat font-semibold text-gray-400 uppercase tracking-wider mb-3">
                  Popular Services
                </p>
